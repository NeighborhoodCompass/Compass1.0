...
class PDF extends FPDF
{
    ...
    $this->SetX(-0.5);
        ...
        $this->Cell(0,0,$this->Image('seals_compass_smaller.png',0.35,10.33,0,0,'PNG', 'http://compass.durhamnc.gov/compass/app/index.html').'Durham Neighborhood Compass - Report generated on: ' . $today['year'] . "." . $today['mon'] . "." . $today['mday'],0,0,'R', false, 'http://durham-compass.durhamnc.gov/compass/app/index.html');
  }
